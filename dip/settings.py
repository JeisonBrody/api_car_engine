...
SECRET_KEY = 'django-insecure-=he06!p-nxqexb-*+fx%($=86#yvls%3_g7iqd*zy(d+1qaso2'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=1),  # Интервал времени активности выданного access_token
    "REFRESH_TOKEN_LIFETIME": timedelta(days=1),    # Интервал времени обновления refresh_token.
    "ROTATE_REFRESH_TOKENS": False,
    "BLACKLIST_AFTER_ROTATION": False,
    "UPDATE_LAST_LOGIN": False,

    "ALGORITHM": "HS256",   # Алгоритм шифрования для формирования подписи (HS256) и используемый для этого секретный ключ
